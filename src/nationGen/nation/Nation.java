...
public class Nation {
    ...
    public void generate(List restrictions) {
        ...
        //at this point the generation was successful

        appendSeedToSeedFile();
	...
	*/
    ...
    private void appendSeedToSeedFile() {

        try (FileWriter fw = new FileWriter("bank.seed", true);
             BufferedWriter bw = new BufferedWriter(fw);
             PrintWriter out = new PrintWriter(bw)) {

            out.println(this.seed);
